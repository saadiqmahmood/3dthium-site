              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-1">
                  <button
                    ...
                    onClick={() => updateCartItemQuantity(item.product.id, item.variant.id, item.size, item.quantity - 1)}
                    disabled={item.quantity <= 1}
                  >
                    -
                  </button>
                  <span className="text-sm text-gray-800 w-6 text-center inline-block">{item.quantity}</span>
                  <button
