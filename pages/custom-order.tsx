...
export default function CustomOrderPage() {
    return (
        <section className="p-8">
            <div className="py-16 px-20 max-w-5xl my-16 mx-auto bg-gray-50 rounded-xl">
                <h1 className="text-3xl font-bold mb-8 text-stone-800 px-8">Request a Custom 3D Print</h1>
