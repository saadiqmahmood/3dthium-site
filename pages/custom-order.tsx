      ...
      <section className="relative bg-zinc-950 py-20 pt-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 text-center">
          <h1 className="text-5xl md:text-6xl font-light text-white mb-6">
            Bring Your <span className="font-semibold bg-gradient-to-r from-emerald-400 to-cyan-400 bg-clip-text text-transparent">Vision</span> to Life
          </h1>
      ...
      <section className="relative py-16 bg-zinc-950 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Step 1 */}
            <div className="text-center p-6 rounded-2xl bg-zinc-900/50 border border-zinc-800 hover:border-zinc-700 transition-all duration-300">
              ...
              <h3 className="text-xl font-medium text-white mb-3">Submit Your Request</h3>
            ...
            <div className="text-center p-6 rounded-2xl bg-zinc-900/50 border border-zinc-800 hover:border-zinc-700 transition-all duration-300">
              ...
              <h3 className="text-xl font-medium text-white mb-3">Get a Quote</h3>
              <p className="text-zinc-400 font-light">
            ...
            <div className="text-center p-6 rounded-2xl bg-zinc-900/50 border border-zinc-800 hover:border-zinc-700 transition-all duration-300">
              ...
              <h3 className="text-xl font-medium text-white mb-3">Receive Your Print</h3>
              <p className="text-zinc-400 font-light">
        ...
        <div className="relative max-w-5xl mx-auto px-6">
          <div className="bg-zinc-900/50 border border-zinc-800 rounded-2xl overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 border-b border-zinc-800 px-8 py-8">
              <h2 className="text-3xl md:text-4xl font-light text-white mb-3">Start Your Custom Project</h2>
      ...
      <section className="relative py-16 bg-zinc-950 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="flex gap-4 p-6 bg-zinc-900/50 border border-zinc-800 hover:border-zinc-700 rounded-2xl transition-all">
              <svg
