      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <section className="relative bg-zinc-950 py-20 pt-32 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-6 text-center">
            <h1 className="text-5xl md:text-6xl font-light text-white mb-6">About 3Dthium</h1>
        ...
        <section className="relative py-16 bg-zinc-950 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 border border-zinc-800 rounded-2xl p-12 text-center">
                <svg
                  ...
                  className="w-32 h-32 text-emerald-400 mx-auto mb-6"
                >
                  <path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" />
                </svg>
                <p className="text-2xl font-semibold text-white">Since 2020</p>
                <p className="text-zinc-400 mt-2 font-light">Years of Innovation</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="relative py-16 bg-zinc-950 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            <h2 className="text-4xl font-light text-center text-white mb-12">Our Values</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Design & Innovation */}
              <div className="bg-zinc-900/50 border border-zinc-800 hover:border-zinc-700 rounded-2xl p-8 transition-all">
                ...
                <h3 className="text-xl font-medium text-white mb-4">Design & Innovation</h3>
              ...
              <div className="bg-zinc-900/50 border border-zinc-800 hover:border-zinc-700 rounded-2xl p-8 transition-all">
                ...
                <h3 className="text-xl font-medium text-white mb-4">Premium Quality</h3>
                <p className="text-zinc-400 leading-relaxed font-light">
              ...
              <div className="bg-zinc-900/50 border border-zinc-800 hover:border-zinc-700 rounded-2xl p-8 transition-all">
                ...
                <h3 className="text-xl font-medium text-white mb-4">Personalized for You</h3>
                <p className="text-zinc-400 leading-relaxed font-light">
        ...
        <section className="relative py-16 bg-zinc-950 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-6">
            <div className="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 border border-zinc-800 rounded-3xl p-12 md:p-16 text-center">
              <h2 className="text-4xl md:text-5xl font-light text-white mb-6">Our Mission</h2>
              <p className="text-lg md:text-xl text-zinc-300 max-w-4xl mx-auto leading-relaxed font-light">
        ...
        <section className="relative py-16 bg-zinc-950 overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-6 text-center">
            <h2 className="text-4xl font-light text-white mb-6">Ready to Get Started?</h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/products"
                className="bg-white text-zinc-950 px-8 py-4 rounded-lg font-medium hover:bg-zinc-100 transition-colors"
              >
                Browse Products
              </Link>
              <Link
                href="/custom-order"
                className="border border-zinc-700 text-white px-8 py-4 rounded-lg font-medium hover:bg-zinc-900 hover:border-zinc-600 transition-colors"
              >
